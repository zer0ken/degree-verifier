...
public class Strings {
    ...
    public static final String CLEAR_COMMIT_DEGREE = "인정한 학위 초기화하기";
    public static final String EXPORT_COMMIT_DEGREE = "인정한 학위 저장하기";
    public static final String OPEN_EXPORT_DIRECTORY = "출력 위치 열기";
    public static final String CLEAR_COMMIT_DIALOG_TITLE = CLEAR_COMMIT_DEGREE;
    public static final String CLEAR_COMMIT_DIALOG_MESSAGE = "이 동작은 되돌릴 수 없습니다. 인정한 학위를 초기화 하시겠습니까?";
